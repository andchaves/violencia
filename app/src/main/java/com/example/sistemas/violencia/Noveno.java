...
public class Noveno extends AppCompatActivity {
    ...
    private ListaViolencia9Adapter listaViolenciaAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaViolenciaAdapter = new ListaViolencia9Adapter(this);
    ...
    private void obtenerListaViolencia() {
        ...
        Call<ArrayList<Violencia>> acueductoRespuestaCall = service.obtenerListaViolencia9();

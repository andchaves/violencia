...
public class Tercero extends AppCompatActivity {
    ...
    private ListaViolencia3Adapter listaViolenciaAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaViolenciaAdapter = new ListaViolencia3Adapter(this);
    ...
    private void obtenerListaViolencia() {
        ...
        Call<ArrayList<Violencia>> acueductoRespuestaCall = service.obtenerListaViolencia3();

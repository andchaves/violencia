...
public class Octavo extends AppCompatActivity {
    ...
    private ListaViolencia8Adapter listaViolenciaAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaViolenciaAdapter = new ListaViolencia8Adapter(this);
    ...
    private void obtenerListaViolencia() {
        ...
        Call<ArrayList<Violencia>> acueductoRespuestaCall = service.obtenerListaViolencia8();

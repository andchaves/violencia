...
public class Sexto extends AppCompatActivity {
    ...
    private ListaViolencia6Adapter listaViolenciaAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaViolenciaAdapter = new ListaViolencia6Adapter(this);
    ...
    private void obtenerListaViolencia() {
        ...
        Call<ArrayList<Violencia>> acueductoRespuestaCall = service.obtenerListaViolencia6();

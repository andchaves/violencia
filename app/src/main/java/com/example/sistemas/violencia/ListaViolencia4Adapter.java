...
public class ListaViolencia4Adapter extends RecyclerView.Adapter<ListaViolencia4Adapter.ViewHolder> {

    private ArrayList<Violencia> dataset;
    private Context context;

    public ListaViolencia4Adapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_lista_violencia4_adapter, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
...

        {
            ...
            if (dataset.get(i).getGrupoDeEdad().equals("(20 a 24)")) {

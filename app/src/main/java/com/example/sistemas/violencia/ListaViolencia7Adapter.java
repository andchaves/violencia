...
public class ListaViolencia7Adapter extends RecyclerView.Adapter<ListaViolencia7Adapter.ViewHolder> {

    private ArrayList<Violencia> dataset;
    private Context context;

    public ListaViolencia7Adapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_lista_violencia7_adapter, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
...

        {
            ...
            if (dataset.get(i).getGrupoDeEdad().equals("(35 a 39)")) {

...
public class ListaViolencia5Adapter extends RecyclerView.Adapter<ListaViolencia5Adapter.ViewHolder> {

    private ArrayList<Violencia> dataset;
    private Context context;

    public ListaViolencia5Adapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_lista_violencia5_adapter, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
...

        {
            ...
            if (dataset.get(i).getGrupoDeEdad().equals("(25 a 29)")) {

...
public class ListaViolencia6Adapter extends RecyclerView.Adapter<ListaViolencia6Adapter.ViewHolder> {

    private ArrayList<Violencia> dataset;
    private Context context;

    public ListaViolencia6Adapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_lista_violencia6_adapter, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
...

        {
            ...
            if (dataset.get(i).getGrupoDeEdad().equals("(30 a 34)")) {

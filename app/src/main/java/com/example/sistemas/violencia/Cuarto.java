...
public class Cuarto extends AppCompatActivity {
    ...
    private ListaViolencia4Adapter listaViolenciaAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaViolenciaAdapter = new ListaViolencia4Adapter(this);
    ...
    private void obtenerListaViolencia() {
        ...
        Call<ArrayList<Violencia>> acueductoRespuestaCall = service.obtenerListaViolencia4();

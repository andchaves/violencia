...
public class ListaViolencia9Adapter extends RecyclerView.Adapter<ListaViolencia9Adapter.ViewHolder> {

    private ArrayList<Violencia> dataset;
    private Context context;

    public ListaViolencia9Adapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_lista_violencia9_adapter, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
...

        {
            ...
            if (dataset.get(i).getGrupoDeEdad().equals("(45 a 49)")) {
